...
# with command line options: step3 --datatier GEN-SIM-RECO,DQMIO --conditions auto:run1_mc -s RAW2DIGI,L1Reco,RECO,EI,VALIDATION,DQM --eventcontent RECOSIM,DQM -n 100 --filein file:step2_DIGI_L1_DIGI2RAW_HLT_RAW2DIGI_L1Reco.root
